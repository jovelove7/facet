...
**지금 Facet Core가 검증하는 것은 이 흐름의 앞쪽 절반입니다.** 회사가 하는 말이 자사 제품 경험까지 살아남는지를 확인하고, 의미가 유지되는 곳과 달라지는 곳을 근거로 보여줍니다. v0.7.0부터는 회사가 말한 대상 고객, 제품 범주, 차별점이 첫 화면과 실제 제품에서 유지되는지도 확인합니다. 검색과 AI가 회사를 어떻게 분류하는지는 아직 다루지 않습니다.
