...
An unedited Facet Core answer, and the repository's example of a promise that holds. The wording here is a design brief, so the audit is decided by scope: it is judged against the surface it governed, and the layers it never addressed are named without a verdict.
...
## OpenAI · "one system, one identity" holds in the visual identity it set out to fix

**Where the message travels**

Rebranding brief → work on a unified visual identity → applied across products and papers → **the problem the brief named is gone**

| Connection | What is actually there |
|---|---|
| Brief → the work | Nine months of work by the in-house design team with two outside partners |
| The work → output | Six or seven scattered typefaces became one, OpenAI Sans |
| Output → application | The same identity reached openai.com, ChatGPT on web and in apps, and the research papers |

**What the company says**

At the February 2025 rebrand, OpenAI head of design Veit Moeller described the instruction he was given: "Sam asked us to create one system, one identity." In the same interview he said that in the three years since ChatGPT launched, nobody had had time to work on a unified identity system. [Fast Company, February 2025](https://www.fastcompany.com/91273217/open-ai-rebrand-chat-gpt-logo)

The problem the brief aimed at is on the record too. The visual identity was inconsistent enough that it often felt like it represented several teams rather than one company. [Creative Review, 6 February 2025](https://www.creativereview.co.uk/openai-brand-refresh/)
